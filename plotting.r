...
baz
plot(foo,bar,type="l")
plot(foo,bar,type="b",main="my lovely plot ",xlab="x axis label",ylab="y axis label ")
plot(foo,bar,type="b",main="my lovely plot ",xlab="",ylab="",col=2)
plot(foo,bar,type="b",main="My lovely plot",xlab="",ylab="",col="seagreen4",pch=20,lwd=2,cex=4,lty=2)
...
segments(x0=c(5,15),y0=c(-5,-5),x1=c(5,15),y1=c(5,5),col="red",lty=3,
         lwd=2)
points(x[y>=5],y[y>=5],pch=20,col="darkmagenta",cex=2)
